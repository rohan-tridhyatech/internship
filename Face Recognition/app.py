...
while True:
	...
	try:
		...
		if results:
			...
			img = cv2.putText(img, 'Rohan', (30, 55), cv2.FONT_HERSHEY_SIMPLEX, 1,
					(255,0,0), 2, cv2.LINE_AA)
			print('Rohan Movaliya Enter....')
			plt.imshow(img)
			plt.show()
			break
	except:
		img = cv2.putText(frame, 'Not Rohan Movaliya', (30, 55), cv2.FONT_HERSHEY_SIMPLEX, 1,
				(255,0,0), 2, cv2.LINE_AA)
